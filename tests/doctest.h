...
#define REQUIRE_DELTA(a, b, delta) REQUIRE( (a) == doctest::Approx((b)).epsilon((delta)) )
#define CHECK_DELTA(a, b, delta) CHECK( (a) == doctest::Approx((b)).epsilon((delta)) )
#define CHECK_EPS(a, b, eps) CHECK( (a) == doctest::Approx((b)).epsilon((eps)) )
#define CHECK_ISNAN(a) CHECK( doctest::IsNaN<decltype((a))>((a)) )
